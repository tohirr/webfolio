...
const Nav = () => {
  ...
  const socialLinks = [
    {
      title: "gmail",
      href: "https://mail.google.com/mail/u/0/?fs=1&to=tohirbabs@gmail.com&su=SUBJECT&body=BODY&tf=cm",
      icon: <SiGmail />,
    },
    ...
    {
      title: "spotify",
      href: "https://open.spotify.com/user/e48xr1tcz09muuqh1oski4qme",
  ...
  const SocialLink = ({ link }) => {
    return (
      <a
        href={link.href}
        target="_blank"
        className="flex lg:gap-3 gap-1 text-white hover:bg-zinc-800 transition cursor-pointer  p-2  rounded-md items-center justify-between"
      >
  ...
  return (
    <div className=" lg:static  w-full duration-300 transition-all overflow-hidden lg:overflow-visible flex flex-col lg:w-64 lg:h-screen sticky top-0">
      <div className="flex  items-center text-white">
        <a
          href="/"
          className="flex justify-between w-full flex-1  hover:bg-zinc-800 p-2 px-3 lg:p-2 rounded-lg items-center gap-2"
        >
      ...
      <div className="flex w-full transition-all flex-col overflow-x-auto lg:pt-6 lg:gap-8">
